...
const SingleFriend = ({ friend }) => {
    return (
        <div className="flex max-sm:flex-col sm:flex-col md:flex-col lg:flex-row items-center justify-center gap-6">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center max-sm:gap-1 sm:gap-1 md:gap-2 lg:gap-6">
                    <div className="flex flex-col items-center gap-1 px-4 py-5 rounded-lg bg-[#FFFFFF] border border-[#E9E9E9] shadow-md">
                ...
                <div className="p-6 rounded-lg bg-[#FFFFFF] border border-[#E9E9E9] shadow-md space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="p-4 rounded-lg bg-[#F8FAFC] border border-[#E9E9E9] flex flex-col items-center justify-center gap-2 w-[30%]">
                            <FaPhoneVolume />
